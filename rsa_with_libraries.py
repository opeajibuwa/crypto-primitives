...
#Converting the RsaKey objects to a string
...
#Instantiating PKCS1_0AEP object with the private key for decryption
decrypt = PKCS1_OAEP.new(key=pr_key)
#Decrypting the message with the PKCS1_0AEP object
